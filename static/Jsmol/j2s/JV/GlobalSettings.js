...
this.setCIR (this.nihResolverFormat);
...
function (template) {
if (template == null || template.equals (this.nihResolverFormat)) return;
...
System.out.println ("CIR resolver set to " + this.nihResolverFormat);
}}, "~S");
