...
Clazz_declarePackage ("JS");
Clazz_load (["J.api.JmolScriptManager", "JU.Lst"], "JS.ScriptManager", ["java.io.BufferedInputStream", "$.BufferedReader", "java.lang.Boolean", "$.Thread", "javajs.api.ZInputStream", "JU.AU", "$.BS", "$.PT", "$.Rdr", "$.SB", "J.api.Interface", "J.i18n.GT", "JS.ScriptQueueThread", "JU.Elements", "$.Logger", "JV.FileManager"], function () {
c$ = Clazz_decorateAsClass (function () {
this.vwr = null;
this.eval = null;
this.evalTemp = null;
...
if (flags == 16) {
flags = 1;
switch (this.vwr.ms.ac > 0 ? javax.swing.JOptionPane.showConfirmDialog (null, J.i18n.GT.$ ("Would you like to replace the current model with the selected model?")) : 0) {
case 2:
return;
case 0:
break;
